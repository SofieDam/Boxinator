        ...
        return (
            <div className="add-box-container">
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input type="name" id="name" placeholder="Enter Reciever Name" onChange={this.handleChange} value={this.state.name}/>
                    <p className="errorMsg">{this.state.nameError}</p>

                    <p className="field-title">Weight:</p>
                    <input type="name" id="weight" placeholder="Enter Weight" onChange={this.handleChange} value={this.state.weight}/>
                    <p className="errorMsg">{this.state.weightError}</p>

                    <p className="field-title">Box Color:</p>
                    <input type="color" id="color" onChange={this.handleChange} value={this.state.color} /> <label>Click to show colorpicker!</label>
                    <p className="errorMsg">{this.state.colorError}</p>

                    <p className="field-title">Destination Country:</p>
